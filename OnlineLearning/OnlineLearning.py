...
def learnAndPlot(targetFunc, numPoints, approximator, degree, learner, funcParam=None, noise=0, sort=False,
                 resolution=1000, learnParam=None):
...
if __name__ == "__main__":
    ...
    learnParam = {"l":1.0, "pInit":100000, "cheb":True}
